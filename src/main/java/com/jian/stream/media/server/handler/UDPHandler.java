package com.jian.stream.media.server.handler;

import com.jian.stream.media.server.UDPServer;
import com.jian.stream.common.utils.BitUtils;
import com.jian.stream.common.utils.HexStringUtils;
import com.jian.stream.media.codec.Packet;
import com.jian.stream.media.codec.Parser;
...
public class UDPHandler  extends SimpleChannelInboundHandler<DatagramPacket>  {
	...
	public UDPHandler(int mSsrc, boolean mIsCheckSsrc, UDPServer parser) {
		this.mSsrc = mSsrc;
